...
class SendProgressButton extends StatefulWidget {
  final SendProgressButtonController controller;
  ...
  @override
  State<StatefulWidget> createState() => SendProgressButtonState();
}

class SendProgressButtonState extends State<SendProgressButton>
  ...
  void initState() {
    ...
    _bounceAnimation.addStatusListener((status) {
...
class SendProgressButtonController {
