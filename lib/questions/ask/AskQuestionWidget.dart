...
class AskQuestionWidget extends StatefulWidget {
  ...
  AskQuestionWidget({this.interestToAsk, this.userToAsk});
              ...
              child: ListTile(
                ...
                leading: widget.userToAsk != null ?
                  ...
                  CircleAvatar(
                    ...
                    child: SvgPicture.network(widget.interestToAsk.icon),
                  ),
                title: widget.userToAsk != null ?
                  Text('Ask a question to ' + widget.userToAsk.getFullName(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),):
                  Text('Ask a question on ' + widget.interestToAsk.label, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              ),
            ),
            Container(
